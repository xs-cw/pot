// Code generated by "pkgimport -p sessions -i github.com/go-pot/sessions -o sessions.go"; DO NOT EDIT.
// Install by "go get -u -v github.com/wzshiming/gotype/cmd/pkgimport";
//go:generate pkgimport -p sessions -i github.com/go-pot/sessions -o sessions.go

package sessions

import (
	origin "github.com/go-pot/sessions"
)
